    ...
    public class EncounterMapperProfile : Profile
    {
        ...
        private Coding GetClass(entitystorematerialised_CoreEncounter coreEncounter)
        {
            ...
            switch (coreEncounter.Patientclasscode.ToLower())
            {
                case "ip":
                case "i":
                    encounterClass.Code = "I";
                    encounterClass.Display = "Inpatient Encounter";
                    break;
                case "op":
                case "o":
                    encounterClass.Code = "O";
                    encounterClass.Display = "Outpatient Encounter";
                    break;
                case "tci":
                case "t":
                    encounterClass.Code = "T";
                    encounterClass.Display = "TCI Encounter";
                    break;
                case "wl":
                case "w":
                    encounterClass.Code = "W";
                    encounterClass.Display = "Waiting List Encounter";
                    break;
            }
        ...
        private List<Identifier> GetEncounterIdentifiers(entitystorematerialised_CoreEncounter coreEncounter)
        {
            ...
            {
                //Value = coreEncounter.Visitnumber //commented to get the unique encounters
                Value= coreEncounter.EncounterId
            };
        ...
        public Period GetEncounterPeriod(entitystorematerialised_CoreEncounter coreEncounter)
        {
            ...
            if (coreEncounter.Admitdatetime != null)
                period.Start = Convert.ToString(new FhirDateTime(coreEncounter.Admitdatetime.Value.Year, coreEncounter.Admitdatetime.Value.Month, coreEncounter.Admitdatetime.Value.Day, coreEncounter.Admitdatetime.Value.Hour, coreEncounter.Admitdatetime.Value.Minute, coreEncounter.Admitdatetime.Value.Second, TimeSpan.Zero));
            if (coreEncounter.Dischargedatetime != null)
                period.End = Convert.ToString(new FhirDateTime(coreEncounter.Dischargedatetime.Value.Year, coreEncounter.Dischargedatetime.Value.Month, coreEncounter.Dischargedatetime.Value.Day, coreEncounter.Dischargedatetime.Value.Hour, coreEncounter.Dischargedatetime.Value.Minute, coreEncounter.Dischargedatetime.Value.Second, TimeSpan.Zero));
